...
<html>
    <head>
		...
		<script src="js/responsiveslides.min.js"></script>
                ...
                <script src="js/register/likno-modal-lib.js" type="text/javascript"></script>
                <script src="js/register/likno-modal-project.js" type="text/javascript"></script>
        <script>
                    ...
                    <div class="left-box">
                        <div class="contact-form">
                            <s:if test="#session.name==null">
                                <h3><s:property value="c.content"/></h3>
                        ...
                        <div class="contact-form">
                            <s:if test="#session.name==null">
                                <form action="checkLogin" method="post">
                                    ...
                                    <div style="float: right"><span><a href="templates/register.jsp" target="register_single"><input type="button" value="Register"/></a><input type="submit" value="Login"/></a></span></div>
                                ...
                                <div>
                                    ...
                                    <div style="float: right"><span><a target="register_single" href="templates/register.jsp"><input type="button" value="Edit"></a></form><a href="Logout"><input type="submit" value="Logout"></a></form></span></div>
                                        </s:else>
                        </div>
                    </div>
                    <div class="clear"> </div>
