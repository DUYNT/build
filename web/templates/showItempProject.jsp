...
<div class="contact-form" style="background: #333">
    ...
    <div class="project" style="padding-right: 1em; padding-bottom: 2em">
        ...
        <table>
            ...
            <tr>
                <td><img style="padding: 20px; border: 2px solid #828282; background: #999; width: 100%; height: 100%" src="<s:property value="p.avatar"/>"/></td>
            </tr>
            
        </table>
    </div>
    <div class="payment" style="padding-left: 2em">
        <table class="zebra" style="width: 100%">
            <tr>
                <td colspan="2" style="color: chartreuse">Project Information</td>
            </tr>
            <tr>
                <td>Time Start</td>
            ...
            <tr>
                <td colspan="2" style="color: chartreuse">Payment Information</td>
            </tr>
            <tr>
                <td>Company</td>
            ...
            <tr>
                <td colspan="2" style="color: chartreuse">Status Project</td>
            </tr>
            <tr>
                <td colspan="2">
