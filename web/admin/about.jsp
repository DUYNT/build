...
<html>
    ...
    <body>
        ...
        <div class="wrap">
                ...
                <div class="top-nav">
                    <ul>
                        <li><a href="homeedit?home=6">Units</a></li>
                        ...
                        <s:if test="#session.home6!=null">
                            ...
                            <table >
                                ...
                                <tr>
                                    ...
                                    <td><s:property value="name"/><a href="deleteUnit?deleteUnit=<s:property value="id"/>">delete</a></td>
                                </tr>
                                </s:iterator>
                                <tr>
                                    <td colspan="2"><form action="units" method="post"><input style="display: none" name="id" value="5"/><input name="name" type="text"/><input type="submit" value="Add"/></form></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><s:property value="#session.errorUnit"/></td>
                                </tr>
                            </table>
                                </div>
                        </s:if>
