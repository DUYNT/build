	...
	<div class="wrap">
		<!---start-header---->
                    <jsp:include page="templates/header.jsp"/>
                         <div class="top-nav">
                        <ul>
                        <li><a href="statusProject?status=5">Sample Project</a></li>
                        <li><a href="#"></a></li>
                        <li><a href="#">|</a></li>
                        <li><a href="#"></a></li>
	...
	<div class="content">
		...
		<div class="gallery">
			<div class="section group">
                            <s:if test="#session.idProjectShow==null">
                            <s:iterator value="listProject">
						<div class="grid_1_of_3
                                                     images_1_of_3" style="width: 27%; height:300px; float: left">
							  ...
							  <p><s:property value="address"/></p>
                                                          <div class="button" style="width: 30%; float: left"><span><a href="showProject?idProjectShow=<s:property value="id"/>"><s:property value="total_price"/>$</a></span></div>
                            ...
                            <s:else> 
                                <jsp:include page="templates/project/itemproject.jsp"/>
                            </s:else>
                            <s:if test="#session.sampleProject!=null">
                                <jsp:include page="templates/project/createProject.jsp"/>
                            </s:if>
						</div>
...
<%
    session.removeAttribute("idProjectShow");
    session.removeAttribute("idProject");
    session.removeAttribute("sampleProject");
